...
# AI Model Settings
AI_MODEL      = "groq/compound-mini"   # fast model for all AI calls
FAST_MODEL    = "groq/compound-mini"   # real-time responses
SMART_MODEL   = "groq/compound"        # use only for deep analysis if needed
AI_TEMPERATURE = 0.7
