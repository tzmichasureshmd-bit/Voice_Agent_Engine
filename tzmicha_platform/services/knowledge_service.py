...
class KnowledgeService:
    ...
    Pipeline:
    1. Upload document (PDF, text, FAQ)
    2. Chunk into smaller pieces (500-800 tokens each)
    3. Generate embeddings for each chunk
    4. Store in Qdrant vector database
    5. During call: query Qdrant with customer question → get relevant chunks → feed to LLM
    
    Each client has isolated knowledge. AI Employee only sees its assigned knowledge base.
    """
